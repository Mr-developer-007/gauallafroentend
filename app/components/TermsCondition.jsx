    ...
    <>
      <main className="mx-5 lg:mx-28  p-6 text-gray-800">
        ...
        <section className="mb-6">
          <p>
            Welcome to <strong>Indian Brass Utensils</strong> (“we,” “our,” or “us”). Your privacy is important to us. This Terms Condition explains how we collect, use, share, and protect your personal information when you visit or make a purchase from our website.
          </p>
        </section>
        ...
        <section className="mb-6">
          ...
          <p className="mt-2">To exercise your rights, email us at: <a href="mailto:your-email@example.com" className="text-blue-600 underline">your-email@example.com</a></p>
        </section>
        ...
        <section className="mb-6">
          ...
          <p>We may update this Terms Condition from time to time. Please review it periodically. Changes are effective once posted here.</p>
        </section>
